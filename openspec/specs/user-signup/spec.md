...
The system SHALL accept a signup submission containing an email address, a username, a password,
and a country.

#### Scenario: Valid fields present
- **WHEN** a request is submitted with a non-empty email, a non-empty username, a non-empty
  password, and a non-empty country

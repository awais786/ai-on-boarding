...
sys.path.insert(0, str(Path(__file__).resolve().parents[1] / "evals"))  # tests/ -> claude-pr-review/ -> evals/

import run_eval as checks  # noqa: E402  - the merged module, imported under its old test name
